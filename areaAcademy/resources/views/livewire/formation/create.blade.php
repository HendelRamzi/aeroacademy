        ...
        <div class="card">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" wire:model.defer="formation.name"  class="form-control" id="name" placeholder="nom de la formation" required>
...
<script type="module">
    ...
    document.getElementById('save').addEventListener('click', (e)=>{
      ...
      editor.save().then((outputData) => {
        @this.desc = JSON.stringify(outputData) ;
        Livewire.emit('addFormation')
      }).catch((error) => {
